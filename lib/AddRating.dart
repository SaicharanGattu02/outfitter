...
class _AddProductRatingState extends State<AddProductRating> {
  ...
  Future<void> SubmitReview() async {
    final data = await Userapi.sendReview(widget.id,rating.toString(), _reviewController.text);
    if (data != "") {
      setState(() {
  ...
  Widget _scaffold(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        // You can use Navigator.pop here if you want to programmatically pop the route
        Navigator.pop(context,true);
        // Return false because we are handling the pop action manually
        return false;
      },
      child: Scaffold(
